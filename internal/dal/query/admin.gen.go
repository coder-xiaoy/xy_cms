...
func newAdmin(db *gorm.DB, opts ...gen.DOOption) admin {
	...
	_admin.adminDo.UseModel(&gen_model.Admin{})
	...
	_admin.Encrypt = field.NewString(tableName, "encrypt")
	_admin.LastTime = field.NewInt32(tableName, "last_time")
	_admin.CreatTime = field.NewInt32(tableName, "creat_time")
	_admin.IsLock = field.NewInt32(tableName, "is_lock")
	_admin.LastIP = field.NewString(tableName, "last_ip")
	_admin.Logins = field.NewInt32(tableName, "logins")
	_admin.GroupID = field.NewInt32(tableName, "group_id")
...
func (a *admin) updateTableName(table string) *admin {
	...
	a.Encrypt = field.NewString(table, "encrypt")
	a.LastTime = field.NewInt32(table, "last_time")
	a.CreatTime = field.NewInt32(table, "creat_time")
	a.IsLock = field.NewInt32(table, "is_lock")
	a.LastIP = field.NewString(table, "last_ip")
	a.Logins = field.NewInt32(table, "logins")
...
func (a *admin) fillFieldMap() {
	...
	a.fieldMap["encrypt"] = a.Encrypt
	a.fieldMap["last_time"] = a.LastTime
	a.fieldMap["creat_time"] = a.CreatTime
	a.fieldMap["is_lock"] = a.IsLock
	a.fieldMap["last_ip"] = a.LastIP
	a.fieldMap["logins"] = a.Logins
...
type IAdminDo interface {
	...
	Unscoped() IAdminDo
	Create(values ...*gen_model.Admin) error
	CreateInBatches(values []*gen_model.Admin, batchSize int) error
	Save(values ...*gen_model.Admin) error
	First() (*gen_model.Admin, error)
	Take() (*gen_model.Admin, error)
	Last() (*gen_model.Admin, error)
	Find() ([]*gen_model.Admin, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gen_model.Admin, err error)
	FindInBatches(result *[]*gen_model.Admin, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*gen_model.Admin) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*gen_model.Admin, error)
	FirstOrCreate() (*gen_model.Admin, error)
	FindByPage(offset int, limit int) (result []*gen_model.Admin, count int64, err error)
...
func (a adminDo) Create(values ...*gen_model.Admin) error {
	if len(values) == 0 {
		return nil
	}
...
func (a adminDo) CreateInBatches(values []*gen_model.Admin, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a adminDo) Save(values ...*gen_model.Admin) error {
	if len(values) == 0 {
		return nil
	}
...
func (a adminDo) First() (*gen_model.Admin, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gen_model.Admin), nil
	}
}

func (a adminDo) Take() (*gen_model.Admin, error) {
...
func (a adminDo) Last() (*gen_model.Admin, error) {
...
func (a adminDo) Find() ([]*gen_model.Admin, error) {
	result, err := a.DO.Find()
	return result.([]*gen_model.Admin), err
}

func (a adminDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gen_model.Admin, err error) {
	buf := make([]*gen_model.Admin, 0, batchSize)
...
func (a adminDo) FindInBatches(result *[]*gen_model.Admin, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a adminDo) FirstOrInit() (*gen_model.Admin, error) {
...
func (a adminDo) FirstOrCreate() (*gen_model.Admin, error) {
...
func (a adminDo) FindByPage(offset int, limit int) (result []*gen_model.Admin, count int64, err error) {
...
func (a adminDo) Delete(models ...*gen_model.Admin) (result gen.ResultInfo, err error) {
