...
func newConfig(db *gorm.DB, opts ...gen.DOOption) config {
	...
	_config.configDo.UseModel(&gen_model.Config{})

	tableName := _config.configDo.TableName()
	_config.ALL = field.NewAsterisk(tableName)
	_config.ID = field.NewInt32(tableName, "id")
	_config.ConfigArray = field.NewString(tableName, "config_array")
	_config.ConfigTag = field.NewString(tableName, "config_tag")
...
type config struct {
	...
	ALL         field.Asterisk
	ID          field.Int32
	ConfigArray field.String
	ConfigTag   field.String
...
func (c *config) updateTableName(table string) *config {
	...
	c.ConfigArray = field.NewString(table, "config_array")
	c.ConfigTag = field.NewString(table, "config_tag")
...
func (c *config) fillFieldMap() {
	...
	c.fieldMap["id"] = c.ID
	c.fieldMap["config_array"] = c.ConfigArray
	c.fieldMap["config_tag"] = c.ConfigTag
}
...
type IConfigDo interface {
	...
	Unscoped() IConfigDo
	Create(values ...*gen_model.Config) error
	CreateInBatches(values []*gen_model.Config, batchSize int) error
	Save(values ...*gen_model.Config) error
	First() (*gen_model.Config, error)
	Take() (*gen_model.Config, error)
	Last() (*gen_model.Config, error)
	Find() ([]*gen_model.Config, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gen_model.Config, err error)
	FindInBatches(result *[]*gen_model.Config, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*gen_model.Config) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*gen_model.Config, error)
	FirstOrCreate() (*gen_model.Config, error)
	FindByPage(offset int, limit int) (result []*gen_model.Config, count int64, err error)
...
func (c configDo) Create(values ...*gen_model.Config) error {
	if len(values) == 0 {
		return nil
	}
...
func (c configDo) CreateInBatches(values []*gen_model.Config, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c configDo) Save(values ...*gen_model.Config) error {
	if len(values) == 0 {
		return nil
	}
...
func (c configDo) First() (*gen_model.Config, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gen_model.Config), nil
	}
}

func (c configDo) Take() (*gen_model.Config, error) {
...
func (c configDo) Last() (*gen_model.Config, error) {
...
func (c configDo) Find() ([]*gen_model.Config, error) {
	result, err := c.DO.Find()
	return result.([]*gen_model.Config), err
}

func (c configDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gen_model.Config, err error) {
	buf := make([]*gen_model.Config, 0, batchSize)
...
func (c configDo) FindInBatches(result *[]*gen_model.Config, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c configDo) FirstOrInit() (*gen_model.Config, error) {
...
func (c configDo) FirstOrCreate() (*gen_model.Config, error) {
...
func (c configDo) FindByPage(offset int, limit int) (result []*gen_model.Config, count int64, err error) {
...
func (c configDo) Delete(models ...*gen_model.Config) (result gen.ResultInfo, err error) {
