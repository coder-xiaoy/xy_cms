...
func newMenu(db *gorm.DB, opts ...gen.DOOption) menu {
	...
	_menu.menuDo.UseModel(&gen_model.Menu{})

	tableName := _menu.menuDo.TableName()
	_menu.ALL = field.NewAsterisk(tableName)
	_menu.Menuid = field.NewInt32(tableName, "menuid")
	...
	_menu.IsShow = field.NewInt32(tableName, "is_show")
	_menu.Groupid = field.NewString(tableName, "groupid")
...
func (m *menu) updateTableName(table string) *menu {
	...
	m.Menuid = field.NewInt32(table, "menuid")
	...
	m.Groupid = field.NewString(table, "groupid")
...
type IMenuDo interface {
	...
	Unscoped() IMenuDo
	Create(values ...*gen_model.Menu) error
	CreateInBatches(values []*gen_model.Menu, batchSize int) error
	Save(values ...*gen_model.Menu) error
	First() (*gen_model.Menu, error)
	Take() (*gen_model.Menu, error)
	Last() (*gen_model.Menu, error)
	Find() ([]*gen_model.Menu, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gen_model.Menu, err error)
	FindInBatches(result *[]*gen_model.Menu, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*gen_model.Menu) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*gen_model.Menu, error)
	FirstOrCreate() (*gen_model.Menu, error)
	FindByPage(offset int, limit int) (result []*gen_model.Menu, count int64, err error)
...
func (m menuDo) Create(values ...*gen_model.Menu) error {
	if len(values) == 0 {
		return nil
	}
...
func (m menuDo) CreateInBatches(values []*gen_model.Menu, batchSize int) error {
	return m.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (m menuDo) Save(values ...*gen_model.Menu) error {
	if len(values) == 0 {
		return nil
	}
...
func (m menuDo) First() (*gen_model.Menu, error) {
	if result, err := m.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gen_model.Menu), nil
	}
}

func (m menuDo) Take() (*gen_model.Menu, error) {
...
func (m menuDo) Last() (*gen_model.Menu, error) {
...
func (m menuDo) Find() ([]*gen_model.Menu, error) {
	result, err := m.DO.Find()
	return result.([]*gen_model.Menu), err
}

func (m menuDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gen_model.Menu, err error) {
	buf := make([]*gen_model.Menu, 0, batchSize)
...
func (m menuDo) FindInBatches(result *[]*gen_model.Menu, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (m menuDo) FirstOrInit() (*gen_model.Menu, error) {
...
func (m menuDo) FirstOrCreate() (*gen_model.Menu, error) {
...
func (m menuDo) FindByPage(offset int, limit int) (result []*gen_model.Menu, count int64, err error) {
...
func (m menuDo) Delete(models ...*gen_model.Menu) (result gen.ResultInfo, err error) {
